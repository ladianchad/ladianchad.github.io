...
\vspace{1em}
\TitledListBegin{
  \TitleWithPeriod{\textbf{Tutoring Mentor of Computer Architecture}, Hanyang University ERICA}{Spring. 2021}
}
\TitledListItem{Provided academic support and supplementary instruction for undergraduate students in Computer Architecture.}
\TitledListItem{Explained RISC-V assembly language and processor design concepts through one-on-one and group tutoring sessions.}
\TitledListEnd
\vspace{1em}
\TitledListBegin{
